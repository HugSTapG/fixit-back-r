import { Controller, Get, Post, Body, Param, Put, UseGuards, ParseIntPipe, Request } from '@nestjs/common';
...
export class UsuariosController {
    ...
    update(@Param('id', ParseIntPipe) id: number, @Body() updateUsuarioDto: any): Observable<any> {
